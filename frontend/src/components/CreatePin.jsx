      ...
      <div className=" flex lg:flex-row dark:bg-gray-900 rounded flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5  w-full">
            ...
            {!imageAsset ? (
              ...
              <label>
                <div className="flex flex-col items-center justify-center h-full">
                  ...
                  <p className="mt-32  dark:text-black text-gray-400">
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          ...
          <input
            ...
            className="outline-none text-base p-2 sm:text-lg rounded border-b-2 border-gray-200 p-2"
          />
