          ...
          <div className="w-full p-5 flex-1 xl:min-w-620">
            ...
            <div className="max-h-370 overflow-y-auto">
              {pinDetail?.comments?.map((item) => (
                <div
                  className="flex gap-2 mt-5 items-center bg-gray-100 dark:bg-gray-600 p-2 rounded-lg"
                  key={item.comment}
                >
                  <img
            ...
            <div className="flex flex-wrap mt-6 gap-3">
              ...
              <input
                className=" flex-1 border-gray-100 outline-none border-2 p-2 dark:text-black rounded focus:border-gray-300"
                type="text"
              ...
              <button
                type="button"
                className="bg-red-500 text-white rounded px-6 py-2 font-semibold text-base outline-none"
                onClick={addComment}
              >
